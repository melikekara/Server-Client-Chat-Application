...
public class Server extends javax.swing.JFrame {
    ...
    ArrayList<String> rooms = new ArrayList<>();//Rooms that created by client.
    ArrayList<String> roomUsers = new ArrayList<>();//Room users that created by client.
            ...
            try {
                while ((message = reader.readLine()) != null) {
                    ...
                    if (data[2].equals("Connect")) {
                        ...
                        sendOneClient(finalString, userID, data[0]); // d[0] here is the reciever person which is the in this case the sender itself 
